defmodule WeltFactoWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WeltFactoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WeltFactoWeb.Gettext, "errors", msg, opts)
    end
  end
