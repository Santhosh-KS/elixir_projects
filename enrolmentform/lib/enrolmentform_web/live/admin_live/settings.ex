defmodule EnrolmentformWeb.AdminLive.Settings do
  use EnrolmentformWeb, :live_view

  on_mount {EnrolmentformWeb.AdminAuth, :require_sudo_mode}
  ...
  def mount(_params, _session, socket) do
    ...
    email_changeset = Accounts.change_admin_email(admin, %{}, validate_email: false)
  ...
  def handle_event("validate_email", params, socket) do
    ...
    email_form =
      ...
      |> Accounts.change_admin_email(admin_params, validate_email: false)
