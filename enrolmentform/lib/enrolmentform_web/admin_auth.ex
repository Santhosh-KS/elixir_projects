defmodule EnrolmentformWeb.AdminAuth do
  ...
  def log_out_admin(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      EnrolmentformWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  def disconnect_sessions(tokens) do
    Enum.each(tokens, fn %{token: token} ->
      EnrolmentformWeb.Endpoint.broadcast(admin_session_topic(token), "disconnect", %{})
    end)
  end
  ...
  the `current_scope`:
      ...
      defmodule EnrolmentformWeb.PageLive do
        use EnrolmentformWeb, :live_view

        on_mount {EnrolmentformWeb.AdminAuth, :mount_current_scope}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{EnrolmentformWeb.AdminAuth, :require_authenticated}] do
