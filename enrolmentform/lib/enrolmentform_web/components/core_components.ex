defmodule EnrolmentformWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(EnrolmentformWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(EnrolmentformWeb.Gettext, "errors", msg, opts)
    end
  end
